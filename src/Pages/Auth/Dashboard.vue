        ...
        <div id="content">
          ...
          <div v-if="statistics" class="dashboard container-fluid py-4">
            ...
            <div class="breadcrumb-auth">
              ...
              <p class="statistics-para">في لوحة التحكم، يمكنك الوصول إلى جميع إحصائياتك بسهولة. تمنحك هذه اللوحة نظرة شاملة على تقدمك وتساعدك في متابعة أهدافك الدراسية.</p>
            </div>
                ...
                <div class="card border-left-info shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col ml-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                          طلاب من مثل مرحلتك التعليمية</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{
