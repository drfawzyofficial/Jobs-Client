                ...
                <div class="col-12">
                    <div class="contactForm form-box" id="ContactForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input required="" type="text" class="form-control form-control-lg" v-model="contactPayload.fullname">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">البريد الإلكتروني</label>
                            <input required="" type="text" class="form-control form-control-lg" v-model="contactPayload.email">
                        </div>
                        <div class="mb-3">
                            <label for="phone" class="form-label">رقم الهاتف</label>
                            <input required="" type="text" class="form-control form-control-lg " pattern="[0-9\-]*" v-model="contactPayload.phone">
                        </div>
                        <div class="mb-4">
