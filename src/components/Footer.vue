...
export default {
    ...
    setup() {
        ...
        // const socialIcons = ref([{ title: "facebook", icon: '<i class="bi bi-facebook"></i>', link: "https://www.facebook.com/" }, { title: "telegram", icon: '<i class="bi bi-telegram"></i>', link: "https://t.me/+uMD9z_GqZJc3NmQ0" }, { title: "whatsapp", icon: '<i class="bi bi-whatsapp"></i>', link: "https://www.whatsapp.com/" }, { title: "Instagram", icon: '   <i class="bi bi-instagram"></i>', link: "https://www.instagram.com/khattitsite/profilecard/?igsh=NTc4MTIwNjQ2YQ==" }, { title: "linkedIn", icon: '<i class="bi bi-linkedin"></i>', link: "https://www.linkedin.com/company/khattit/about/?viewAsMember=true" }, { title: "twitter", icon: '<i class="bi bi-twitter-x"></i>', link: "https://www.x.com/" }]);
